...
|---|---|
| [zfs-wasm](./zfs-wasm) | A browser-hosted WebAssembly snapshot filesystem demo with copy-on-write branching, rollback, and a live interactive UI. Live demo: <https://adamziel.github.io/experiments/zfs-wasm/> |
