...
|---|---|
| [zfs-wasm](./zfs-wasm) | A browser-hosted WebAssembly snapshot filesystem demo with copy-on-write branching, rollback, and a live interactive UI. Includes the full Rust/JS/Wasm build pipeline, and GitHub Pages rebuilds the demo from those checked-in sources on deploy. Live demo: <https://adamziel.github.io/experiments/zfs-wasm/> |
